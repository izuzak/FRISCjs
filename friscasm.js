  ...
  var result = {
    ...
    parse: function(input, startRule) {
      ...
      function parse_instructions() {
        ...
        var savedPos0 = pos;
        var result2 = parse_instruction_or_end();
        if (result2 !== null) {
          var result3 = [];
          var savedPos1 = pos;
          var result5 = parse_newline();
          if (result5 !== null) {
            var result6 = parse_instruction_or_end();
            if (result6 !== null) {
      ...
      function parse_instruction_or_end() {
        ...
        var result4 = parse_instruction_end();
        var result3 = result4 !== null
          ? (function(i) { var ins = i; ins.line = linecounter-1; return ins;})(result4)
          : null;
        if (result3 !== null) {
          var result0 = result3;
        } else {
      ...
      function parse_instruction_end() {
        ...
        if (result2 !== null) {
          ...
          if (result3 !== null) {
            var result4 = parse_endop();
            if (result4 !== null) {
              var result11 = parse_commentPart();
      ...
      function parse_instruction() {
        ...
        var savedPos0 = pos;
        var result7 = parse_label();
        var result2 = result7 !== null ? result7 : '';
        if (result2 !== null) {
          var result6 = parse_operationPart();
          var result3 = result6 !== null ? result6 : '';
          if (result3 !== null) {
            var result5 = parse_commentPart();
      ...
      function parse_regaddr() {
        ...
        var result0 = result1 !== null
          ? (function(value) { return {type : "register", value : value} })(result1)
          : null;
      ...
      function parse_sraddr() {
        ...
        var result0 = result1 !== null
          ? (function(value) { return {type : "sr"} })(result1)
          : null;
      ...
      function parse_immaddr() {
        ...
        var result3 = result4 !== null
          ? (function(value) { return {type : "number", value : value} })(result4)
          : null;
        if (result3 !== null) {
          var result0 = result3;
        } else {
      ...
      function parse_absaddr_mem() {
        ...
        var result6 = result7 !== null
          ? (function(value) { return {type : "label", value : value} })(result7[1])
          : null;
        if (result6 !== null) {
          var result0 = result6;
        } else {
          ...
          var result1 = result2 !== null
            ? (function(value) { return {type : "number", value : value} })(result2[1])
            : null;
          if (result1 !== null) {
            var result0 = result1;
          } else {
      ...
      function parse_rinaddroff() {
        ...
        if (result2 !== null) {
          ...
          if (result3 !== null) {
            ...
            if (result11 !== null) {
              var result12 = parse_numberWithoutBase();
              if (result12 !== null) {
            ...
            if (result10 !== null) {
              ...
              var savedReportMatchFailuresVar0 = reportMatchFailures;
              reportMatchFailures = false;
              var result9 = parse_numberWithoutBase();
              reportMatchFailures = savedReportMatchFailuresVar0;
              if (result9 === null) {
                var result7 = '';
              } else {
      ...
      function parse_uprop_name() {
        var cacheKey = 'uprop_name@' + pos;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = cachedResult.nextPos;
          return cachedResult.result;
      ...
      function parse_aluop() {
        ...
        if (result2 !== null) {
          ...
          if (result3 !== null) {
            ...
            if (result4 !== null) {
              var result5 = parse_delimiter();
              if (result5 !== null) {
                var result10 = parse_regaddr();
                if (result10 !== null) {
                  var result6 = result10;
                } else {
                  var result9 = parse_immaddr();
                  if (result9 !== null) {
                    var result6 = result9;
                  } else {
                    var result6 = null;;
                ...
                if (result6 !== null) {
                  var result7 = parse_delimiter();
                  if (result7 !== null) {
                    var result8 = parse_register();
                    if (result8 !== null) {
      ...
      function parse_uprop() {
        ...
        var savedPos1 = pos;
        var result7 = parse_uprop_name();
        if (result7 !== null) {
          var result8 = parse_flag();
          if (result8 !== null) {
            ...
            if (result9 !== null) {
              var result12 = parse_immaddr();
              if (result12 !== null) {
                var result10 = result12;
              } else {
                var result11 = parse_rinaddr();
                if (result11 !== null) {
        ...
        if (result5 !== null) {
          ...
          var savedPos0 = pos;
          var result3 = parse_uprop_name();
          if (result3 !== null) {
            var result4 = parse_flag();
            if (result4 !== null) {
        ...
        if (result2 !== null) {
          ...
          if (result3 !== null) {
            ...
            if (result4 !== null) {
              var result5 = parse_delimiter();
              if (result5 !== null) {
                var result8 = parse_rinaddroff();
                if (result8 !== null) {
                  var result6 = result8;
                } else {
                  var result7 = parse_absaddr_mem();
                  if (result7 !== null) {
                    var result6 = result7;
                  } else {
                    var result6 = null;;
      ...
      function parse_stackop() {
        ...
        var savedPos0 = pos;
        var result2 = parse_stackop_name();
        if (result2 !== null) {
          var result5 = parse_whitespace();
          if (result5 !== null) {
            var result3 = [];
